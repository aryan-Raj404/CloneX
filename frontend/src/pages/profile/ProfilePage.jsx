...
import { IoCalendarOutline, IoChatbubble } from "react-icons/io5";
                ...
                {!isMyProfile && (
                  <>
                    ...
                    <Link to={`/messages/${user?.username}`}>
                      <button className="btn btn-primary rounded-full btn-sm text-white flex items-center gap-2">
